...
export default function ProfileGateCard({ image, name }) {
  return (
    <div className="group flex flex-col items-center gap-2">
      {' '}
      <div className="w-[100px] md:w-[150px] border-zinc-900 hover:border-zinc-300 border-4 cursor-pointer rounded-md flex items-center justify-center aspect-square hover:bg-zinc-300">
        {image && (
