...
export default function Edit({ handleClick }) {
  const [values, setValues] = useState({
    game: '',
  });

  return (
    <span className="w-full flex items-center justify-center  min-h-screen bg-black ">
      <div className="w-full md:p-8   md:w-[60%] h-full flex flex-col justify-center items-start  ">
        ...
        <div className="h-[130px] gap-3 px-4 pt-3 w-full flex items-start">
          ...
          <div className="h-full gap-2 flex-grow flex flex-col">
            <input
              className="bg-zinc-600 text-white py-2 outline-none border-none p-3"
              type="text"
              aria-label="name"
            />
        ...
        <div className="text-zinc-300 pb-3 md:mb-12 pr-3 mt-4 flex items-start flex-col gap-2 self-end w-[75%]">
